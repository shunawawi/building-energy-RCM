...
eObjFunc.. vZ =e= sum(jj, vPD_cost(jj) + sum(tt, vEnvDamage(jj,tt) + vElecCost(jj,tt)));
...
eFindPD(jj,tt).. vPeakDemand(jj) =g= vHeatPumpElectricity(jj,tt);
...
display vED_cost.l;
display vE_cost.l;
display vAggElecDemand.l;
display vAvgTemp.l;
display vSumPeakDemand.l;
...
execute 'gdxxrw.exe results.gdx o=MB_Full_Detroit_v1.xlsx var=vAggElecDemand.l rng=HPe!A1 var=vAvgTemp.l rng=AvgTemp!A1';
